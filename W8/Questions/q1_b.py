...
c_sq_train, [W_bar_train_post, b_bar_train_post] = linreg_cost((W_train_fit_post, b_train_fit_post), X_train_post, y_train, alpha)
c_rmse_train = np.sqrt(c_sq_train/len(X_train_post))

print('Training RMSE: ' + str(c_rmse_train))

c_sq_val, [W_bar_val_post, b_bar_val_post] = linreg_cost((W_train_fit_post, b_train_fit_post), X_val_post, y_val, alpha)
